...
class _RepairPhotoPageState extends State<RepairPhotoPage> {
          ...
          Center(
            child: Text(
              ...
              style: GoogleFonts.mavenPro(
                fontSize: ResponsiveWidget.isLargeScreen(context) ? 70 : ResponsiveWidget.isMediumScreen(context) ? 60 : 50,
  ...
  void _repair(imageSelected, filename) async {
    ...
    if(result != null){
      setState(
        () => {repair = true, imageRepaired = base64Decode(result['content']), isLoading = false});
    }
